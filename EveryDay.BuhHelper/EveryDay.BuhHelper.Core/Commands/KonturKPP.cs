...
{
    /// <summary>
    /// Кроме первоначальной информации выводит еще КПП
    /// </summary>
    public class KonturKPPCommand : ICommand
    {
        private string TOKEN => "3208d29d15c507395db770d0e65f3711e40374df";

        public string Name => "innKPP";
        ...
        public ICommandResult Exec(string arg)
        {
            ...
            result.Result = $"{cont.UL.LegalName.Full} {cont.UL.Heads[0].Fio} {cont.UL.KPP[0].ToString()}";
